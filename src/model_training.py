...
class ModelTraining:
    def __init__(self,data_path):
        ...
        if not api_key:
            raise CustomException("COMET_API_KEY not found in environment variables")


        self.experiment = comet_ml.Experiment(
            api_key=api_key,
            project_name="hybrid-recommendation-system",
            workspace="igopalakrishna"
        )
    ...
    def train_model(self):
        try:
            ...
            logger.error(str(e))
            raise CustomException("Error occured during Model Trainig Process",e)
