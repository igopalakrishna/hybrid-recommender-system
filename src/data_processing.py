...
class DataProcessor:
    ...
    def filter_users(self,min_rating=400):
        try:
            ...
            logger.info("Filtered users succedsfully...")
        except Exception as e:
    ...
    def scale_ratings(self):
        try:
            ...
            logger.info("Scaled done for Processing ")
        except Exception as e:
    ...
    def split_data(self, test_size=1000 , random_state=43):
        try:
            ...
            logger.info("Data splitted succesfully")
    ...
    def save_artifacts(self):
        try:
            ...
            logger.info("All the training testing data as well as rating_df is saved.")
        except Exception as e:
    ...
    def run(self):
        try:
            ...
            logger.info("Data Processing Pipeline Ran Succesfully!")
